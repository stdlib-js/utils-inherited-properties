...
```javascript
inheritedProperties = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-inherited-properties@v0.3.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-inherited-properties/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/utils-inherited-properties/actions/workflows/test.yml?query=branch:v0.3.1
